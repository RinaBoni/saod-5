...
int main() {
    ...
    cout << "Ќачальный массив (n=20)" << endl;
    fout << "Ќачальный массив (n=20)" << endl;
    ...
    //печать исходного массива
    cout << "Ќачальный массив (n=200)" << endl;
    fout << "Ќачальный массив (n=200)" << endl;
    ...
    while (!h1.ListEmpty()) { //пока в 1-й пирамиде есть элементы
        int buf = h1.Delete(); //извлекаем элемент из 1-й
        h2.Insert(buf); //и вставл€ем во 2-ю
    }
